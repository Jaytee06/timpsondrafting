...
const nav = `<a class="brand" href="/">Timpson <span>Drafting &amp; Design</span></a><button class="nav-toggle" aria-expanded="false" aria-controls="site-nav">Menu</button><nav id="site-nav" aria-label="Primary"><details><summary>Services</summary><div class="menu"><a href="/residential-drafting-services/">Residential Drafting Services</a><a href="/custom-home-plans/">Custom Home Plans</a><a href="/adu-plans/">ADU Plans</a><a href="/home-addition-plans/">Home Addition Plans</a><a href="/garage-shop-plans/">Garage and Shop Plans</a><a href="/remodel-drafting/">Remodel Drafting</a><a href="/as-built-drawings/">As-Built Drawings</a></div></details><a href="/projects/">Projects</a><details><summary>Service Areas</summary><div class="menu"><a href="/southern-utah-drafting-services/">Southern Utah</a><a href="/northern-arizona-drafting-services/">Northern Arizona</a><a href="/service-areas/remote-drafting/">Remote Drafting</a></div></details><a href="/resources/">Resources</a><a href="/about-us/">About</a><a class="nav-cta" href="/#contact">Request a Quote</a></nav>`;
...
function renderHub(region) {
  ...
  const body = `<section class="hero"><p class="eyebrow">Regional service hub</p><h1>Residential drafting services across ${escapeHtml(region)}</h1><p>Timpson evaluates residential drafting projects from the actual property, scope, source information, and reviewing jurisdiction. Remote coordination is available; field service depends on the location and work required.</p><div class="actions"><a class="button primary" href="/#contact">Request a Quote</a><a class="button secondary" href="tel:+14353195331">Call (435) 319-5331</a></div></section><section class="section"><h2>Enabled ${escapeHtml(region)} locations</h2><div class="cards">${cards}</div></section><section class="section"><h2>Residential services</h2><div class="link-grid"><a href="/custom-home-plans/">Custom home drafting</a><a href="/adu-plans/">ADU plans</a><a href="/home-addition-plans/">Home addition plans</a><a href="/garage-shop-plans/">Garage and shop plans</a><a href="/remodel-drafting/">Remodel drafting</a><a href="/projects/">Residential project library</a></div></section>`;
